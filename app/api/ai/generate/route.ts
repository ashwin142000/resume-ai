...
export async function POST(req: Request) {
  try {
    ...
    // UPDATED PROMPT: Aggressive ATS optimization, keyword weaving, and human-like tone
    const promptText = `
      ...
      4. Human-Created Tone: Write in a natural, professional, and convincing human tone. Avoid robotic, overly complex AI jargon (e.g., do not use words like "spearheaded a synergistic paradigm shift").
      5. NO AI FORMATTING: DO NOT start your bullet points or sentences with hyphens (-), asterisks (*), slashes (/), or bullet characters. Provide clean, plain text sentences. The JSON array structure will handle the bullet points in the UI.
